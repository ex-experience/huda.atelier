(function(){
  ...
  function boot(){
    ...
    if(!document.querySelector('.nav-panel')){
      ...
      p.innerHTML='<button type="button" class="close" data-close-nav>×</button><a href="index.html">Portfolio</a><a href="services.html">Services</a><a href="shop.html">The Edit</a><a href="academy.html">Academy</a><a href="digital.html">Digital</a><a href="concierge.html">Concierge</a><a href="../privacy.html">Privacy</a>';
      ...
      p.querySelector('[data-close-nav]').addEventListener('click',close);
    }
  }
